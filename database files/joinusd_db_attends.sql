...
CREATE TABLE `attends` (
  ...
  PRIMARY KEY (`UN`,`EID`),
  KEY `EID_FKA_idx` (`EID`),
  CONSTRAINT `EID_FKA` FOREIGN KEY (`EID`) REFERENCES `event` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `UN_FKA` FOREIGN KEY (`UN`) REFERENCES `user` (`UserName`) ON DELETE CASCADE ON UPDATE CASCADE
